        ...
        <section id="hero" className="w-full">
          <div className="grid gap-6 lg:grid-cols-2 lg:gap-12">
            <div className="flex flex-col justify-center space-y-4">
              <div className="space-y-2 lg:mx-10">
                ...
                <div className="flex space-x-4 mt-6">
                  <a
                    ...
                    className="inline-flex items-center justify-center px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm text-sm font-medium text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700"
                  >
                    <svg
            ...
            <div className="flex items-center justify-center">
              <img
                src="/black1.webp?height=400&width=400"
                alt="Kahyberth Gonzalez"
